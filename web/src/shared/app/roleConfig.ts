...
export const workshopConfig: RoleConfig = {
  ...
  productLabel: 'Mebel Pro',
  roleLabel: 'Workshop',
  tenantLabel: 'Workshop account',
  tenantMeta: 'branch access',
  homePath: '/workshop',
  loginPath: '/auth/login',
  ...
  nav: [
    ...
    { label: 'Finance', to: '/workshop/finance' },
...
export const adminConfig: RoleConfig = {
  ...
  nav: [
    ...
    { label: 'Jobs', to: '/admin/platform/jobs' },
    { label: 'Errors', to: '/admin/platform/errors' },
    { label: 'Platform users', to: '/admin/platform/users' },
