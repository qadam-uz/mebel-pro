...
from app.services.authz import BranchScope, resolve_branch_scope
from app.services.files import IMAGE_CONTENT_TYPES, attach_file, replace_attached_file
from app.services.platform import require_platform_operator
...
async def add_branch_material(
    ...
    *,
    ...
    db.add(row)
    await db.flush()
    from app.services.inventory import ensure_stock_item_for_branch_material
...
async def update_branch_material(
    ...
    *,
    ...
    if payload.min_stock is not None:
        ...
        from app.services.inventory import sync_stock_item_min_stock
