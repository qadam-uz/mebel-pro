...
from app.modules.inventory import invoice_routes as inventory_invoice_routes
...
api_router.include_router(client_portal_public_routes.router)
...
api_router.include_router(inventory_invoice_routes.router)
api_router.include_router(inventory_routes.router)
api_router.include_router(inventory_routes.stock_router)
