...
from app.models.catalog import Manufacturer, Material
...
def _material_response(record: MaterialRecord) -> MaterialResponse:
    return _material_from_models(record.material, record.manufacturer)


def _material_from_models(material: Material, manufacturer: Manufacturer) -> MaterialResponse:
