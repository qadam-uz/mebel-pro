...
| `manage_catalog`       | the branch's own materials — attach the o'lchamlar the branch carries, set each one's price, activate / deactivate; and, when the platform's library lacks one, **create the workshop's own manufacturer, dekor or o'lcham** and edit the dekorlar it owns ([`catalog-inventory.md`](catalog-inventory.md#decor-formats-the-library-and-the-workshops-own)). The library itself stays platform-side.                                                                                                                                                                                                                                     |
