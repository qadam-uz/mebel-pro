...
1. **For the workshop:** their operations live in a dozen disconnected places. One system that
   models branches, the material catalog, stock, pricing, and orders together, with a real
   cutting optimizer and an audit trail, removes the phone-and-paper layer and the per-order
   arithmetic.
...
[`scope.md`](scope.md) — what v1 covers and what it deliberately doesn't.
